#!/bin/bash
# Starts the MLflow tracking server for class 3.
...
# localhost and private IPs, but not Docker service names — so without this line, calls
# from the other containers to http://mlflow:5000 come back as
# "Invalid Host header - possible DNS rebinding attack detected".
#
#   mlflow:5000     how the bonsai and jupyter containers reach it
